...
with open("/srv/chirpanalytica/de/training/export/export_count.dat", "rb") as handle:
    count = pickle.load(handle)

with open("/srv/chirpanalytica/de/training/export/export_tfidf.dat", "rb") as handle:
    tf_transformer = pickle.load(handle)

with open("/srv/chirpanalytica/de/training/export/export_clf.dat", "rb") as handle:
    clf = pickle.load(handle)

with open("/srv/chirpanalytica/de/training/export/export_fractions.dat", "rb") as handle:
